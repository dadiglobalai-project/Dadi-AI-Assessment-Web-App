...
import { assignQuestionsForAttempt, getAssignedQuestionsForAttempt, getAssessmentQuestionConfig } from "./assessment.service";
...
export const getApplicantAssessmentService = async ({ body, params, query: requestQuery, file }: ServiceRequest): Promise<ServiceResult> => {
