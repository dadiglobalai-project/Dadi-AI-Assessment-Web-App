...
import { normalizeDifficulty, parseQuestionDifficulty } from "./assessment.service";
...
export const updateAssessmentQuestionConfigService = async ({ body, params, query: requestQuery, file }: ServiceRequest): Promise<ServiceResult> => {
...
export const createQuestionService = async ({ body, params, query: requestQuery, file }: ServiceRequest): Promise<ServiceResult> => {
  const req = { body, params, query: requestQuery, file };
  const { res, getResult } = createServiceResponder();
...
export const updateQuestionService = async ({ body, params, query: requestQuery, file }: ServiceRequest): Promise<ServiceResult> => {
  const req = { body, params, query: requestQuery, file };
  const { res, getResult } = createServiceResponder();
...
export const deleteQuestionService = async ({ body, params, query: requestQuery, file }: ServiceRequest): Promise<ServiceResult> => {
  const req = { body, params, query: requestQuery, file };
  const { res, getResult } = createServiceResponder();
...
export const generateQuestionsWithAIService = async ({ body, params, query: requestQuery, file }: ServiceRequest): Promise<ServiceResult> => {
  const req = { body, params, query: requestQuery, file };
  const { res, getResult } = createServiceResponder();
